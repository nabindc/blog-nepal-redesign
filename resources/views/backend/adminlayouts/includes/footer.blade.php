        ...
        <!-- footer -->
        <!-- ============================================================== -->
        <footer class="footer text-center text-danger" >
            © 2018 BlogAdmin template by A_xut-Dev
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
    ...
    <script src="{{asset('public/backend/assets/node_modules/skycons/skycons.js')}}"></script>
    <!--morris JavaScript -->
    ...
    <!-- Chart JS -->
    <script src="{{asset('public/backend/dist/js/dashboard4.js')}}"></script>
