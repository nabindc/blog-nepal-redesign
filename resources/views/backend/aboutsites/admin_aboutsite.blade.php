                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40" enctype="multipart/form-data" method="post" action="{{route('store.about')}}">
                                 @csrf
                     ...
                     <input type="text" class="form-control form-control-line" name="sub_title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <textarea name="video" rows="8" cols="80" class="form-control"></textarea>
