            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">View categories</h4>
                    </div>
                                    ...
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td>{{$category->slug}}</td>
                                                <td>
                                                <a href="{{route('edit.category', $category->id)}}" class="btn btn-danger"><i class="fa fa-edit"></i></a>
                                                <a id="delCat" href="{{route('delete.category', $category->id)}}" class="btn btn-danger">
