 ...
 @section('content')  
       ...
       <div class="page-wrapper">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="{{asset('public/backend/uploads/profile/'.$user->image)}}" class="rounded-circle" width="150" />
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="post" action="{{route('update.profile', $user->id)}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="about" id="summernote">
                                                {{$user->about}}
                                            </textarea>
                                        </div>
                                    </div>
